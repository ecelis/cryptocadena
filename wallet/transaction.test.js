...
describe('Transaction', () => {
    ...
    describe('validTransaction()', () => {
        ...
        describe('when transaction is invalid', () => {
            ...
            describe('and the transaction input signature is invalide', () => {
                it('returns false and logs an error', () => {
    ...
    describe('update()', () => {
        ...
        describe('and the amount is valid', () => {
            ...
            it('sub stracts the amount of the original sender output amount',
            () => {
                expect(transaction.outputMap[senderWallet.publicKey])
            ...
            describe('and another update for the same recipient', ()=> {
                ...
                it(' should subtract from theoriginal sender otput amount', () => {
                    expect(transaction.outputMap[senderWallet.publicKey])
    ...
    describe('rewardTransaction()', () => {
        ...
        it('creates one tx with the reward input', () => {
            expect(rewardTransaction.input).toEqual(REWARD_INPUT);
        });

        it('creates one tx for the miner with mineng reward', () => {
